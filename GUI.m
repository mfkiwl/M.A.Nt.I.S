...
% Last Modified by GUIDE v2.5 22-Dec-2016 11:42:56
...
status1 = 'Gathering Data. Please wait...';
status2 = 'Idle';

set(handles.status,'string',status1);
[times, turns] = main;
plotPath(times, turns);
set(handles.status,'string',status2);
